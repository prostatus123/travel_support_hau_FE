    ...
    return (
        <>
            <tr >
                ...
                <td className="text-center" style={{ verticalAlign: 'middle' }}>{data?.activitiesInfoDTO?.title}</td>
                <td className="text-center" style={{ verticalAlign: 'middle' }}>{data?.price} VNĐ</td>
                ...
                <ModalUpdate handleClose={handleCloseUpdate} handleShow={handleShowUpdate} show={showUpdate} bookingId={data?.bookingId} search={search}
