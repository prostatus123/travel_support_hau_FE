...
export default function BookingRestaurant() {
    ...
    let search = async () => {
        let path = `/member/restaurant/booking/list?page=${activePage - 1}&perPage=${limits}&status=${status}`;
        ...
        <>
            ...
            <div className="wrapp_search">
                    ...
                    >
                        ...
                        <option value="BOOKING_APPROVED" >Đã phê duyệt</option>
                    ...
                    <table id="example1" className="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th className="text-center" style={{ verticalAlign: 'middle' }}>Kiểu nhà hàng</th>
                                <th className="text-center" style={{ verticalAlign: 'middle' }}>Ngày đặt</th>
