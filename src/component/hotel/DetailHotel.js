            ...
            <div className="wrapper__search--detail container">
                ...
                <div className="top__content">
                    <div className="top__content--left">
                        <p className="content">Địa chỉ: {hotel?.address}</p>
                    </div>
                    <div className="top__content--right">
                        <span className="icon"><FontAwesomeIcon className="icon__heart" icon={faHeart} /></span>
                            ...
                            return (
                                <div className="row row__item--order">
                                    ...
                                    <div className="col-3 col__content--item">
                                        <span className="price">{currencyFormat(item?.price?.toString())}</span> {item?.currency}
                                    </div>
