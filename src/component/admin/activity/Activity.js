...
export default function Activity() {
    ...
    let search = async () => {
        let path = `/employee/activities/list?activities_name=${name}&status=${status}&activePage=${activePage - 1}`;
                    ...
                    <table id="example1" className="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th className="text-center" style={{ verticalAlign: 'middle' }}>Tên khu vui chơi</th>
                                <th className="text-center" style={{ verticalAlign: 'middle' }}>Giá vé trẻ con</th>
                                <th className="text-center" style={{ verticalAlign: 'middle' }}>Giá vé người lớn</th>
