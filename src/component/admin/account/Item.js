    ...
    return (
        <>
            <tr >
                ...
                <td className="text-center" style={{ verticalAlign: 'middle' }}>{moment(data?.dob,"YYYYMMDD").format("DD/MM/YYYY")}</td>
                <td className="text-center" style={{ verticalAlign: 'middle' }}>{data?.roleName}</td>
                <td className="text-center" style={{ verticalAlign: 'middle' }}>
                    {data?.image &&
                        <img src={`${BASE_URL_DOWNLOAD}${data?.image}`} style={{ width: 100, height: 50 }} />
                    }
                ...
                <td style={{ verticalAlign: 'middle' }} className="btn__setting">
                    ...
                    <ModalUpdate handleClose={handleCloseUpdate} handleShow={handleShowUpdate} show={showUpdate} id={data?.id} search={search} account={data} />
