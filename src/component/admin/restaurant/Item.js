...
import { statusHotel, typeActivity, typeRestaurant } from '../../../utils/amenities';
        ...
        <>
            <tr >
                ...
                <td style={{ verticalAlign: 'middle' }} className="btn__setting">
                    ...
                    />
                    <ModalUploadMenu search={search} handleClose={handleClose} handleShow={handleShow} show={show} restaurantCode={data?.code} />
