...
export default function Hotel() {
    ...
    let search = async () => {
        let path = `/employee/hotel/list?hotel_name=${name}&status=${status}&activePage=${activePage - 1}`;
                    ...
                    <table id="example1" className="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th className="text-center" style={{ verticalAlign: 'middle' }}>Tên khách sạn</th>
                                <th className="text-center" style={{ verticalAlign: 'middle' }}>Giá tiền</th>
