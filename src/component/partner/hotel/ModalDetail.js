...
export default function ModalDetail({ show, handleClose, slug, isUpload ,typeHotelName,star,rank}) {
                        ...
                        {metas?.length > 0 ?
                            <table>
                                ...
                                <tbody>
                                    {metas?.map((item, idx) => {
                                        return (
                                            <Item item={item} key={idx} idx={idx}
                                                search={search} handleTypeRoomName={handleTypeRoomName} hotel={hotel}
                                            />
                                        )
                                    })}
                                </tbody>
...
function Item({ item, idx, search, handleTypeRoomName, hotel }) {
