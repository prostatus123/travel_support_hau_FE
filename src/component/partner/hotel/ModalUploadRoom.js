                        ...
                        <div>
                            <ul className="menu">
                                <li className="menu__item">
                                    <div className="menu__item--title">Tên Phòng:</div>
                                    <div className="menu__item--input">
                                        <input type="text"
                                            {...register("hotelOptionCode", { required: true })}
                                        />
                                    </div>
                                    {errors.hotelOptionCode && <span style={{color:'red'}}>Trường này không được bỏ trống *</span>}
                                </li>
                                <li className="menu__item">
                                    ...
                                    {errors.price && <span style={{color:'red'}}>Trường này không được bỏ trống *</span>}
                                </li>
