    ...
    return (
        <>
            <tr >
                ...
                <ModalUpdate handleClose={handleCloseUpdate} handleShow={handleShowUpdate} show={showUpdate} data={activities} images={activities?.images} search={search}
                    activitiesCode={activities?.code}
                    type={data?.type}
                />
                <td style={{ verticalAlign: 'middle' }} className="btn__setting">
                    ...
                    <ModalUploadGame search={search} handleClose={handleClose} handleShow={handleShow} show={show} activitiesCode={data?.code} handleUpload={handleUpload} />
